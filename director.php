...
<body>
  ...
  <div class="top-bar">
    ...
    <div id="about" class="section wb" style="padding: 0px 0;">
        <div class="container">
            <div class="row">
                <div class="col-md-13">
                  
                        
                        <h2>Welcome to Bangalore IAS Academy</h2><br>
                        
                       
                            <div class="post-media wow fadeIn">
                            <img style="width:200%;" src="uploads/Team/arjun bopanna.jpeg" alt="" class="img-fluid img-rounded">
                        
                            </div><p></p>
                       
                        <h3 style="text-align: center">Dr. ARJUN BOPANNA </h3><br>
