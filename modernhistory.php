                ...
                <div class="col-md-12">
                    <div class="banner">
                        ...
                        <ul class="page-title-link">
                            ...
                            <li><a href="#">MODERN INDIAN HISTORY</a></li> -->
                        </ul>
                    </div>
                </div>
            </div>
            ...
            <div class="container" style="background-color: #fbfbfb; padding-bottom: 20px;">
                ...
                <div class="row">
                    <div class="col-md-12" style="padding-top: 10px;">
                       <center> <img src="uploads/mat7.jpg" alt="" class="img-fluid img-rounded" class="center" style="float: center;"><br></center><br>
                        <h1 style="text-align: center;">MODERN INDIAN HISTORY</h1>
                ...
                <div class="row">
                    ...
                    <div class="col-md-5">  
                        <ol >
                            ...
                            <li><i class="fa fa-dot-circle-o"></i> Decline of the Mughals</li>
                            <li><i class="fa fa-dot-circle-o"></i> Emergence of New States</li>
                            <li><i class="fa fa-dot-circle-o"></i> Hyderabad</li>
                            <li><i class="fa fa-dot-circle-o"></i> Awadh</li>
                            <li><i class="fa fa-dot-circle-o"></i> Bengal</li>
                            <li><i class="fa fa-dot-circle-o"></i> Mysore province</li>
                            <li><i class="fa fa-dot-circle-o"></i> Rajputs</li>
                            <li><i class="fa fa-dot-circle-o"></i> KERALA</li>
                            <li><i class="fa fa-dot-circle-o"></i> The Marathas</li>
                            <li><i class="fa fa-dot-circle-o"></i> The Sikhs</li>
                            <li><i class="fa fa-dot-circle-o"></i> Advent of Europeans</li>
                            <li><i class="fa fa-dot-circle-o"></i> The policies of the British empire in India (1757-1857)</li>
                            <li><i class="fa fa-dot-circle-o"></i> Revolt of 1857</li>
                            <li><i class="fa fa-dot-circle-o"></i> British policies during 1861-1900</li>
                            <li><i class="fa fa-dot-circle-o"></i> Rise of Indian nationalism</li>
                            <li><i class="fa fa-dot-circle-o"></i> Moderate phase (1885 – 1905)</li>
                            <li><i class="fa fa-dot-circle-o"></i> Extremist phase (1905-1920)</li>
                            <li><i class="fa fa-dot-circle-o"></i> Revolutionary phase -1</li>
                            <li><i class="fa fa-dot-circle-o"></i> First World War & Nationalist Response</li>
                            <li><i class="fa fa-dot-circle-o"></i> Emergence of Gandhi</li> 
                            <li><i class="fa fa-dot-circle-o"></i> Revolutionary activity during 1920’s</li>
                            <li><i class="fa fa-dot-circle-o"></i> Civil Disobedience Movement</li>
                            <li><i class="fa fa-dot-circle-o"></i> SECOND WORLD WAR AND NATIONALIST 'RESPONSE</li>  
                            <li><i class="fa fa-dot-circle-o"></i> 19th Century Socio Religious Reform Movements</li>  
                            <li><i class="fa fa-dot-circle-o"></i> Revolts and uprisings</li>  
                            <li><i class="fa fa-dot-circle-o"></i> INC sessions</li>  
                            <li><i class="fa fa-dot-circle-o"></i> Previous year Prelims Questions (2011-18)</li>  
                        </ol>   
                    </div>
