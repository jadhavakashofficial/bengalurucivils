...
<body>
  ...
  <div class="top-bar">
    ...
    <div class="banner">
            <img src="uploads/banner/bangalore-ias-academy-2.png" style="width: 100%;">
          </div>
        <div class="container">
            <div class="row">
                <div class="col-md-12">
            ...
            <div class="container" style="background-color: #fbfbfb; padding-bottom: 20px;">
                ...
                <div class="row">
                    <div class="col-md-12" style="padding-top: 10px;">
                       <center> <img src="uploads/mat2.png" alt="" class="img-fluid img-rounded" class="center" style="float: center;"><br></center><br>
                        <h1 style="text-align: center;">Indian Economy</h1>
                ...
                <div class="row">
                    ...
                    <div class="col-md-5">  
                        <ol >
                            ...
                            <li><i class="fa fa-dot-circle-o"></i> INTRODUCTION</li>
                            <li><i class="fa fa-dot-circle-o"></i> NATIONAL INCOME</li>
                            <li><i class="fa fa-dot-circle-o"></i> ECONOMIC GROWTH AND DEVELOPMENT</li>
                            <li><i class="fa fa-dot-circle-o"></i> PLANNING IN INDIA</li>
                            <li><i class="fa fa-dot-circle-o"></i> FISCAL POLICY</li>
                            <li><i class="fa fa-dot-circle-o"></i> MONETARY POLICY </li>
                            <li><i class="fa fa-dot-circle-o"></i> FINANCIAL INSTITUTIONS</li>
                            <li><i class="fa fa-dot-circle-o"></i> BANKING</li>
                            <li><i class="fa fa-dot-circle-o"></i> FINANCIAL INCLUSION</li>
                            <li><i class="fa fa-dot-circle-o"></i> FINANCIAL MARKETS</li>
                            <li><i class="fa fa-dot-circle-o"></i> EXTERNAL SECTOR </li>
                            <li><i class="fa fa-dot-circle-o"></i> BALANCE OF PAYMENTS</li>
                            <li><i class="fa fa-dot-circle-o"></i> CONVERTIBILITY</li>
                            <li><i class="fa fa-dot-circle-o"></i> FOREIGN CAPITAL</li>
                            <li><i class="fa fa-dot-circle-o"></i> TRADE AND COMMERCE</li>
                            <li><i class="fa fa-dot-circle-o"></i> WORLD TRADE ORGANISATION (WTO)</li>
                            <li><i class="fa fa-dot-circle-o"></i> REGIONAL TRADE BLOCS</li>
                            <li><i class="fa fa-dot-circle-o"></i> BRETTON WOODS TWINS</li>
                            <li><i class="fa fa-dot-circle-o"></i> WORLD BANK</li>
                            <li><i class="fa fa-dot-circle-o"></i> INTERNATIONAL MONETARY FUND (IMF)</li> 
                            <li><i class="fa fa-dot-circle-o"></i> BRICS</li>
                            <li><i class="fa fa-dot-circle-o"></i> BLACK MONEY</li>
                            <li><i class="fa fa-dot-circle-o"></i> DEMONETIZATION</li>  
                            <li><i class="fa fa-dot-circle-o"></i> INFLATION</li>  
                            <li><i class="fa fa-dot-circle-o"></i> RECESSION</li>  
