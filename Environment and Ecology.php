                ...
                <div class="col-md-12">
                    <div class="banner">
                        ...
                        <ul class="page-title-link">
                            ...
                            <li><a href="#">Environment and Ecology</a></li> -->
                        </ul>
                    </div>
                </div>
            </div>
            ...
            <div class="container" style="background-color: #fbfbfb; padding-bottom: 20px;">
                ...
                <div class="row">
                    <div class="col-md-12" style="padding-top: 10px;">
                       <center> <img src="uploads/mat1.jpg" alt="" class="img-fluid img-rounded" class="center" style="float: center;"><br></center><br>
                        <h1 style="text-align: center;">Environment and Ecology</h1>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-5">  
                        <ol >
                            ...
                            <li><i class="fa fa-dot-circle-o"></i>Biogeochemical Cycles</li>
                            <li><i class="fa fa-dot-circle-o"></i>TERRESTRIAL ECOSYSTEM</li>
                            <li><i class="fa fa-dot-circle-o"></i>AQUATIC ECOSYSTEM</li>
                            <li><i class="fa fa-dot-circle-o"></i>WETLAND ECOSYSTEM</li>
                            <li><i class="fa fa-dot-circle-o"></i>ENVIRONMENT POLLUTION</li>
                            <li><i class="fa fa-dot-circle-o"></i>Environmental Impact Assessment</li>
                            <li><i class="fa fa-dot-circle-o"></i>BIODIVERSITY</li>
                            <li><i class="fa fa-dot-circle-o"></i>PROTECTED AREA NETWORK</li>
                            <li><i class="fa fa-dot-circle-o"></i>CLIMATE CHANGE</li>
                            <li><i class="fa fa-dot-circle-o"></i>CLIMATE CHANGE MITIGATION STRATEGIES</li>
                            <li><i class="fa fa-dot-circle-o"></i>INDIA AND CLIMATE CHANGE</li>
                            <li><i class="fa fa-dot-circle-o"></i>CLIMATE CHANGE ORGANIZATIONS</li>
                            <li><i class="fa fa-dot-circle-o"></i>OZONE HOLE</li>
                            <li><i class="fa fa-dot-circle-o"></i>AGRICULTURE</li>
                            <li><i class="fa fa-dot-circle-o"></i> ACT AND POLICIES</li>
                            <li><i class="fa fa-dot-circle-o"></i>INSTITUTIONS AND MEASURES</li>
                            <li><i class="fa fa-dot-circle-o"></i>INTERNATIONAL CONVENTIONS</li>
                            <li><i class="fa fa-dot-circle-o"></i>ENVIRONMENT ISSUES AND HEALTH EFFECTS</li>
                            <li><i class="fa fa-dot-circle-o"></i>CURRENT TOPICS</li>
