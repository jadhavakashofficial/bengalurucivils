...
$que1 = "select * from current__mains where id= $kid";
...
<meta charset="utf-8">
    ...
    <meta name="keywords" content="<?php echo $row1['desc'] ?>">
...
<body>
  ...
  <div class="top-bar">
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbar">
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li><a class="active" href="current_affairs.php">Current Affairs</a></li>
    ...
    <div class="container">
            <div>
                <h1 class="mt-0 text-uppercase font-28 ">Daily <span class="text-theme-color-2 font-weight-400" style="color: orange;">CURRENT AFFAIRS</span></h1>
                            ...
                            <?php 
                                $id= $_GET['id'];
                                include("config/config.php");
                                         $sql = "SELECT * FROM current__details WHERE main_id=$id";
        ...
        <div class="container">
                ...
                <div class="col-md-10">
                         ...
                         <div class="col-md-15">
                            ...
                            <h4 style="color:red; text-align:center;">'.$row["name"].' </h4> <br>
                             <img src = ../admin_ias/public/'.$row["photo"].' / style="width: 600px;">
                              <p></p>
                            </div>
      ...
      <div class="blink_second" >
        ...
        <div class="side-navi-data">
            <div class="side-navi-tab">
                <div>
                              <!-- <marquee width="100%"><h4><strong>***</strong><b><u><a target="_blank" href="">Title Here</a></u></b><strong>**</strong></h4></marquee> -->
                    <div class="item-main">
                      <h5><p><b>New Updates</b></p></h5>
                     <ul class="no-style pull-left">
                      <?php 
                        include("config/config.php");
                        $que = "select * from update__notifications where id > 1";
...
s1.async=true;
s1.src='https://embed.tawk.to/5c34429b361b3372892eee54/default';
s1.charset='UTF-8';
...
<script type="text/javascript">
    ...
    function loadSiasaVideos(date){
        ...
        var obj = { Title: "Daily Current Affairs", Url:"/daily-currentaffair?date="+date };
        history.pushState(obj, obj.Title, obj.Url);
        
        var baseurl = "index.php";
        $('.preloaders').css({"display": "block"});
        $('#table-1_wrapper').css({"display": "none"});
        $.ajax({type: "POST",url: "https://www.iasshiksha.com/load-daily-currentaffair",data: {date : date},cache: false,
        success: function(data){
             ...
             if(obj['code'] && obj['code'] == 200){
                    ...
                    content += '<td><h3>' + items[i].title + ' Current Affairs for - ' + items[i].date +'</h3></td>';
                    content += '</tr>';
                    }
    ...
    <script type="text/javascript" src="assets/js/vendor/detectmobilebrowser/detectmobilebrowser.js"></script>
    <script type="text/javascript" src="assets/js/vendor/switchery/dist/switchery.min.js"></script>
    <script type="text/javascript" src="assets/js/vendor/DataTables/js/jquery.dataTables.min.js"></script>
    <script type="text/javascript" src="assets/js/vendor/DataTables/js/dataTables.bootstrap4.min.js"></script>
    <script type="text/javascript" src="assets/js/vendor/DataTables/Responsive/js/dataTables.responsive.min.js"></script>
    <script type="text/javascript" src="assets/js/vendor/DataTables/Responsive/js/responsive.bootstrap4.min.js"></script>
    <script type="text/javascript">
