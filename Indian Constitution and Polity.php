                ...
                <div class="col-md-12">
                    <div class="banner">
                        ...
                        <ul class="page-title-link">
                            ...
                            <li><a href="#">Indian Constitution and Polity</a></li> -->
                        </ul>
                    </div>
                </div>
            </div>
    ...
    <br>
            ...
            <div class="container" style="background-color: #fbfbfb; padding-bottom: 20px;">
                ...
                <div class="row">
                    <div class="col-md-12" style="padding-top: 10px;">
                       <center> <img src="uploads/mat5.jpg" alt="" class="img-fluid img-rounded" class="center" style="float: center;"><br></center><br>
                        <h1 style="text-align: center;">Indian Constitution and Polity</h1>
            ...
            <div class="container" style="background-color: #fbfbfb;">
                <div class="row">
                    ...
                    <div class="col-md-5">  
                        <ol >
                            <li><i class="fa fa-dot-circle-o"></i> SALIENT FEATURES OF THE CONSTITUTION</li>
                            <li><i class="fa fa-dot-circle-o"></i> Preamble to Indian Constitution</li>
                            <li><i class="fa fa-dot-circle-o"></i> Union and its territory</li>
                            <li><i class="fa fa-dot-circle-o"></i> Citizenship </li>
                            <li><i class="fa fa-dot-circle-o"></i> The Fundamental Rights</li>
                            <li><i class="fa fa-dot-circle-o"></i> Directive Principles of State Policy</li>
                            <li><i class="fa fa-dot-circle-o"></i> FUNDAMENTAL DUTIES</li>
                            <li><i class="fa fa-dot-circle-o"></i> THE PRESIDENT</li>
                            <li><i class="fa fa-dot-circle-o"></i> Vice-President</li>
                            <li><i class="fa fa-dot-circle-o"></i> Prime Minister</li>
                            <li><i class="fa fa-dot-circle-o"></i> Council of Ministers</li>
                            <li><i class="fa fa-dot-circle-o"></i> Parliament </li>
                            <li><i class="fa fa-dot-circle-o"></i> The Supreme Court</li>
                            <li><i class="fa fa-dot-circle-o"></i> High court </li>
                            <li><i class="fa fa-dot-circle-o"></i> The Subordinate courts </li>
                            <li><i class="fa fa-dot-circle-o"></i> State Government </li>
                            <li><i class="fa fa-dot-circle-o"></i> The Governor</li>
                            <li><i class="fa fa-dot-circle-o"></i> Chief Minister</li>
                            <li><i class="fa fa-dot-circle-o"></i> State council of Ministers</li>
                            <li><i class="fa fa-dot-circle-o"></i> State legislature</li> 
                            <li><i class="fa fa-dot-circle-o"></i> Panchayati Raj</li>
                            <li><i class="fa fa-dot-circle-o"></i> Urban Local Government </li>
                            <li><i class="fa fa-dot-circle-o"></i> UNION TERRITORIES </li>  
