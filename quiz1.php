...
<link rel="canonical" href="daily-currentaffair.html" />
		...
		<div class="container" align="center">
            ...
            <div>
                <div style="text-align: center;">
                  <?php if($type == 1){ ?>
                            <h2>Banking Daily Quiz</h2>
                          <?php }
                          else{ ?>
                            <h2>IAS/KAS Daily Quiz</h2>
                         <?php  } ?>
                </div>
            </div>
                        <?php 
                ...
                $que = "select * from quiz__days where type=$id and sub_cat_id=$cid ORDER BY date DESC";
                                ...
                                <td>
                                    <?php
                                     $counter = 1;
                                        ...
                                        $sql = "SELECT * from quiz__days where type = $id and sub_cat_id = $cid and date = '$row[date]'";
                                        
                                       $query1 = mysqli_query($con1,$sql);
                                        while($row1 = mysqli_fetch_array($query1))
                                        {
                                              ...
                                              echo'  <tbody>
                                                    ...
                                                    <div class="container">
                                                        ...
                                                        <h4 class="one" align="center"><a href=start-quiz.php?id='.$row1["type"].'&date='.$row1["date"].'>  &nbsp; ' . $row1["examname"]. '  </a></h4><br>
...
s0.parentNode.insertBefore(s1,s0);
        ...
        //var dates= '2019-01-23'
              ...
              <?php
                                      ...
                                      if($type == 1){
                                        ...
                                        $sql = "SELECT * FROM quiz__days WHERE type=1";
                                      }
                                      else{
                              
                                        $sql = "SELECT * FROM quiz__days WHERE type=2";
                                      }
    ...
    $("#DateSelected_start_quiz").click(function(){
        // var type = $("#QuizTypeSelected").val();
        var date = $("#QuizDateSelected").val();
        if(date === '' || date == '0' || date == '0000-00-00'){
            alert("Please Select Date");
            return false;
            }else{
                location.href = "start-quiz.php?date="+date;
                return false;
            }
