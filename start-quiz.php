...
<section class="content quiz" id="start_quiz_content" style="">
    <div class="container">
            <div ng-controller="listCtrl as list" ng-hide="list.quizMetrics.quizActive || list.quizMetrics.resultsActive" class="ng-scope">
        <h1>START DAILY QUIZ</h1>
        <div class="col-xs-12 col-sm-12">
            ...
            <h3>Quiz for the Date: <?php echo $date; ?></h3>
                         <p>This quiz is intended to introduce you to concepts and certain important facts relevant to Banking, UPSC IAS civil services preliminary exam. It is not a test of your knowledge. 
                         Discuss the concepts and facts they try to test from you and suggest improvements.</p>
                         <br>
          ...
          <a class="btn btn-primary" href="start.php?id=<?php echo $date;?>&type=<?php echo $aa;?>"><b>Start Quiz</b></a></from>
