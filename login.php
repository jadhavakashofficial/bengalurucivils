...
<body>
  ...
  <div class="top-bar">
    ...
    <div id="main-top-index-nad"></div>
<div class="clr"></div>
<nav class="navbar navbar-default navbar-fixed-center" >
<div class="container">
  ...
  <form class="form-signin" method="POST" action="login_script.php">
      ...
      <input type="password" name="password" id="inputPassword" class="form-control" placeholder="Password" required>
        <br>
      <button class="btn  btn-block" type="submit" name="submit"/>Sign in</button>

      <a href="index.php" class="btn  btn-block">
      Cancel</a>
      <a href="signup.php" class="btn  btn-block">
