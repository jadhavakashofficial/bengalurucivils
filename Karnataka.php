                ...
                <div class="col-md-12">
                    <div class="banner">
                        ...
                        <ul class="page-title-link">
                            <!-- <li><a href="#">Matrials</a></li>
                            <li><a href="#">Karnataka Geography</a></li> -->
                        </ul>
                    </div>
                </div>
            </div>
            ...
            <div class="container" style="background-color: #fbfbfb; padding-bottom: 20px;">
                ...
                <div class="row">
                    <div class="col-md-12" style="padding-top: 10px;">
                       <center> <img src="uploads/mat4.jpg" alt="" class="img-fluid img-rounded" class="center" style="float: center;"><br></center><br>
                        <h1 style="text-align: center;">Karnataka Geography</h1>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-5">  
                        <ol >
                            ...
                            <li><i class="fa fa-dot-circle-o"></i> RELIEF FEATURES</li>
                            <li><i class="fa fa-dot-circle-o"></i> CLIMATE</li>
                            <li><i class="fa fa-dot-circle-o"></i> DRAINAGE SYSTEM</li>
                            <li><i class="fa fa-dot-circle-o"></i> SOILS</li>
                            <li><i class="fa fa-dot-circle-o"></i> INATURAL VEGETATION</li>
                            <li><i class="fa fa-dot-circle-o"></i> IRRIGATION</li>
                            <li><i class="fa fa-dot-circle-o"></i> AGRICULTURE</li>
                            <li><i class="fa fa-dot-circle-o"></i> FISHING</li>
                            <li><i class="fa fa-dot-circle-o"></i> Animal Husbandry</li>
                            <li><i class="fa fa-dot-circle-o"></i> MINERAL RESOURCES</li>
                             <li><i class="fa fa-dot-circle-o"></i> INDUSTRIES</li>
                            

                        </ol>   
                    </div>
                    <div class="col-lg-5" style="padding-top: 80px; text-align: center;">
