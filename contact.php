            ...
            <div class="row">
                    ...
                    <div class="contact_form">
                        <div id="message">
                            <div class="section-title text-center">
                                <h3>Get in touch</h3>
                                <p class="lead">Let us give you more details, Please fill out the form below. <br>We are happy to contact and serve You!</p>
                            </div>
                        </div>
                        <form class="row" action="contact_me.php" name="contactform" method="post">
                            <!-- <fieldset class="row"> -->
                                ...
                                <div class="col-lg-12 col-md-10 col-sm-12">
                                    <input type="text" name="mobile" id="mail" class="form-control" placeholder="Your Mobile">
                                </div>
                                ...
                                <div class="text-center cont-btn">
                                    <button type="submit" value="SEND" class="btn11"><span>Submit</span></button>
                                </div>
                            <!-- </fieldset> -->
                        </form>
                    </div>
				...
				<div class="col-sm-6">
					...
					<div class="address-item">
						...
						<h3>Address</h3>
						<p>P18, 2nd Floor, Near Hebbal Police Station Bellary Main Road, Hebbal, Bengaluru, Karnataka 560024
							<br><br> 2nd floor, 211, 5th Main Rd, Hampi Nagar, RPC Layout, Vijaya Nagar, Bengaluru, Karnataka 560104</p>
					</div>
                </div>
            </div>
            <div class="row" style="padding-top: 30px;">
                ...
                <div class="col-sm-6">
					...
					<div class="address-item">
						...
						<h3>Call Us</h3>
						<p>+91 98861-51564 / 98867-77417</p>
