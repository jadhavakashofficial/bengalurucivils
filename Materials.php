        ...
        <div class="container-fluid">
            ...
            <div id="da-thumbs" class="da-thumbs portfolio">
                <div class="post-media pitem item-w1 item-h1 cat1">
                    <a href="Indian Economy.php">
                        <img src="uploads/Materials/1.png" alt="">
                        
                    </a>
                </div>
                <div class="post-media pitem item-w1 item-h1 cat2">
                    <a href="modernhistory.php">
                        <img src="uploads/Materials/2.jpg" alt="" class="img-responsive">
                        
                    </a>
                </div>
                <div class="post-media pitem item-w1 item-h1 cat1">
                    <a href="Environment and Ecology.php">
                        <img src="uploads/Materials/3.jpg" alt="" class="img-responsive">
                        
                    </a>
                </div>
                <div class="post-media pitem item-w1 item-h1 cat4">
                    <a href="Indian Geography.php">
                        <img src="uploads/Materials/4.jpg" alt="" class="img-responsive">
                ...
                <div class="post-media pitem item-w1 item-h1 cat2">
                    <a href="Geography.php">
                        <img src="uploads/Materials/7.jpg" alt="" class="img-responsive">
                        
                    </a>
                </div>
                 <div class="post-media pitem item-w1 item-h1 cat2">
                    <a href="Indian Constitution and Polity.php">
                        <img src="uploads/Materials/6.jpg" alt="" class="img-responsive">
                 ...
                 <div class="post-media pitem item-w1 item-h1 cat3">
                    <a href="Karnataka.php">
                        <img src="uploads/Materials/5.jpg" alt="" class="img-responsive">
                       
                    </a>
                </div>
                <div class="post-media pitem item-w1 item-h1 cat3">
                    <a href="karnatakahistory.php">
                        <img src="uploads/Materials/8.jpg" alt="" class="img-responsive">
