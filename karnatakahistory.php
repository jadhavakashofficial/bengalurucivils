...
<body>
  ...
  <div class="top-bar">
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbar">
                    <ul class="navbar-nav ml-auto">
                        ...
                        <!--      </div>-->
                        <!--</div>-->
                        <li><a class="active" href="https://www.instamojo.com/bangalorecivils/">Store</a></li>
    ...
    <div class="banner">
            <img src="uploads/banner/Slider3.jpg" style="width: 100%;">
          </div>
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <div class="banner">
                        ...
                        <ul class="page-title-link">
                            ...
                            <li><a href="#">Karnataka History</a></li> -->
                        </ul>
                    </div>
                </div>
            </div>
...
<body>
    ...
    <br>
            ...
            <div class="container" style="background-color: #fbfbfb; padding-bottom: 20px;">

                   
                <div class="row">
                    <div class="col-md-12" style="padding-top: 10px;">
                       <center> <img src="uploads/met.jpg" alt="" class="img-fluid img-rounded" class="center" style="float: center;"><br></center><br>
                        <h1 style="text-align: center;">Karnataka History</h1>
            ...
            <div class="container" style="background-color: #fbfbfb;">
                <div class="row">
                    ...
                    <div class="col-md-5">  
                        <ol>
                            <h1 style="text-align: center;"><li>CONTENTS</li></h1>
                            <li><i class="fa fa-dot-circle-o"></i> KARNATAKA – ITS ANTIQUITY</li>
                            <li><i class="fa fa-dot-circle-o"></i> THE SATAVAHANAS</li>
                            <li><i class="fa fa-dot-circle-o"></i> KADAMBA DYNASTY</li>
                            <li><i class="fa fa-dot-circle-o"></i> THE GANGAS</li>
                            <li><i class="fa fa-dot-circle-o"></i> CHALUKYAS OF BADAMI</li>
                            <li><i class="fa fa-dot-circle-o"></i> RASHTRAKUTAS</li>
                            <li><i class="fa fa-dot-circle-o"></i> CHALUKYAS OF KALYANI</li>
                            <li><i class="fa fa-dot-circle-o"></i> THE HOYSALAS OF DWARASAMUDRA</li>
                            <li><i class="fa fa-dot-circle-o"></i> VIJAYANAGARA EMPIRE</li>
                            <li><i class="fa fa-dot-circle-o"></i> BAHMANI KINGDOM </li>
                            <li><i class="fa fa-dot-circle-o"></i> THE ADIL SHAHI DYNASTY</li>
                            <li><i class="fa fa-dot-circle-o"></i> THE NAYAKAS</li>
                            <li><i class="fa fa-dot-circle-o"></i> THE NAYAKAS OF KELADI</li>
                            <li><i class="fa fa-dot-circle-o"></i> NAYAKAS OF CHITRADURGA</li>
                            <li><i class="fa fa-dot-circle-o"></i> THE YELAHANKA NADAPRABHUS</li>
                            <li><i class="fa fa-dot-circle-o"></i> THE WODEYARS OF MYSORE</li>
                            <li><i class="fa fa-dot-circle-o"></i> HYDER ALI AND TIPPU SULTAN</li>
                            <li><i class="fa fa-dot-circle-o"></i> RULE OF COMMISSIONERS</li>
                            <li><i class="fa fa-dot-circle-o"></i> THE DIVANS OF MYSORE</li>
                            <li><i class="fa fa-dot-circle-o"></i> REBELLION IN KARNATAKA</li> 
                            <li><i class="fa fa-dot-circle-o"></i> UPRISINGS DURING REVOLT OF 1857</li>
                            <li><i class="fa fa-dot-circle-o"></i> FREEDOM MOVEMENT IN KARNATAKA PRE-GANDHIAN PERIOD</li>
                            <li><i class="fa fa-dot-circle-o"></i> FREEDOM MOVEMENT IN KARNATAKA GANDHIAN PERIOD</li>  
                            <li><i class="fa fa-dot-circle-o"></i> MOVEMENT IN PRINCELY STATE</li>  
                            <li><i class="fa fa-dot-circle-o"></i> MYSORE CHALO MOVEMENT</li>  
                            <li><i class="fa fa-dot-circle-o"></i> MOVEMENT IN HYDERABAD KARNATAKA</li>  
                            <li><i class="fa fa-dot-circle-o"></i> UNIFICATION OF KARNATAKA</li>  
                            <li><i class="fa fa-dot-circle-o"></i> THE ROLE OF WOMEN IN THE FREEDOM MOVEMENT</li>  
                            <li><i class="fa fa-dot-circle-o"></i> RENAISSANCE IN KARNATAKA </li>  
                              
                        </ol>   
                    </div>
                    <div class="col-lg-5" style="padding-top: 200px; text-align: center;">
                           <img src="images/buy.png"><br>
                           <h2>To Buy Now Contact +91 98861-51564 or Mail Us at bangalorecivils@gmail.com</h2> 
                    </div>
                </div>
            </div>
...
<div class="row collapse">
    <div class="columns medium-6 show-for-medium">
        <div class="soft--ends soft--left">
            <div class="portrait-image-center-cropped" style="background-image:url(https://media.instamojo.com/imgs/81dff090f79e4cbe9e93cfcba81f5b59.jpg)"></div>
        </div>
    </div>
    ...
    <div class="columns small-12 medium-6">
        <div class="offer-container">
            <h3 class="font-rc product-title text-word-wrap-break-word">DECEMBER 2018 Mahithi Monthly Current Affairs Magazine- English (e-copy)</h3><div class="actionbar">
                <span>
                    <span class="caps strong" style="color:#3B96E0;cursor:pointer"><i class="nc-icon-outline ui-2_share-bold" style="margin-right:6px">
                        
                    </i>Share</span></span></div><div class="offer__info-block"><ul class="list-dotted soft--top flush--left"><li>Document</li><li>35 MB</li></ul></div><div class="offer__pricing-block"><div class="offer__pricing-block__price soft--top"><span><i class="icon icon-inr"></i>75</span></div><div class="row soft--top"><div class="columns small-12"><button class="btn-green btn-block caps">Buy Now</button>
                    </div>
                </div></div></div></div></div>
