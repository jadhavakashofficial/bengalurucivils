                    ...
                    <div class="banner">
                        ...
                        <ul class="page-title-link">
                           <!--  <li><a href="#">Matrials</a></li>
                            <li><a href="#">Indian Geography</a></li> -->
                        </ul>
                    </div>
                </div>
            </div>
    ...
    <br>
            ...
            <div class="container" style="background-color: #fbfbfb; padding-bottom: 20px;">
                ...
                <div class="row">
                    <div class="col-md-12" style="padding-top: 10px;">
                       <center> <img src="uploads/mat3.jpg" alt="" class="img-fluid img-rounded" class="center" style="float: center;"><br></center><br>
                        <h1 style="text-align: center;">Indian Geography</h1>
                    </div>
            ...
            <div class="container" style="background-color: #fbfbfb;">
                <div class="row">
                    ...
                    <div class="col-md-5">  
                        <ol >
                            <li><i class="fa fa-dot-circle-o"></i> India As A Geographical Unit</li>
                            <li><i class="fa fa-dot-circle-o"></i> Geology of India</li>
                            <li><i class="fa fa-dot-circle-o"></i> Physical Divisions of India</li>
                            <li><i class="fa fa-dot-circle-o"></i> Drainage system</li>
                            <li><i class="fa fa-dot-circle-o"></i> Drainage Systems in India</li>
                            <li><i class="fa fa-dot-circle-o"></i> Indian Climate</li>
                            <li><i class="fa fa-dot-circle-o"></i> Natural Vegetation of India</li>
                            <li><i class="fa fa-dot-circle-o"></i> Soil of India</li>
                            

                        </ol>   
                    </div>
                    <div class="col-lg-5" style="padding-top: 50px; text-align: center;">
