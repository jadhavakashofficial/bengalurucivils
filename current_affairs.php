  ...
  <section class="content news">
    <div class="container">
            <div>
                ...
                <h1 class="mt-0 text-uppercase font-28 "><span style="color: orange;">CURRENT AFFAIRS</span></h1>
                <?php 
                include("config/config.php");
                $que = "select * from current__mains GROUP BY date ORDER BY date DESC";
                        ...
                        while($row = mysqli_fetch_array($query))
                        {
                          ...
                          $month=date("F",$time);
                          $year=date("Y",$time);
                                  echo "<h4>Current Affair For The Month Of  $month $year</h4>";
                  ?>
                                ...
                                <td>
                                    <?php
                                     $counter = 1;
                                        ...
                                        $sql = "SELECT * from current__mains where date = '$row[date]'";
                                        ...
                                        while($row1 = mysqli_fetch_array($query1))
                                        {
                                              ...
                                              echo'  <tbody>
                                                    ...
                                                    <div class="container">
                                                        ...
                                                        <h4 class="one"><a href=current_affairs_details.php?id='.$row1["id"].'>  &nbsp; ' . $row1["name"]. '  </a></h4><br>
...
$(document).ready(function(){
   $('#view_Send_enquiry').modal('show');
   localStorage.view_Send_enquiry = "false";
});
</script>
